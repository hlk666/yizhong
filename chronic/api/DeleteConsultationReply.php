...
class DeleteConsultationReply extends BaseApi
{
    protected function validate($class = '')
    {
        ...
        if (false === Dbi::getDbi()->existedConsultationReplied($this->param['consultation_id'])) {
    ...
    {
        $ret = Dbi::getDbi()->deleteConsultationReply($this->param['consultation_id']);
