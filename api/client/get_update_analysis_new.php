...
$folders = scandir(PATH_UPDATE . 'analysis_new');
$versionDir = '';
...
$dir = PATH_UPDATE . 'analysis_new' . DIRECTORY_SEPARATOR . $versionDir;
            ...
            if (is_dir($dir . DIRECTORY_SEPARATOR . $file)) {
                ...
                foreach ($subFiles as $subFile) {
                    if ($subFile != '.' && $subFile != '..') {
                        ...
                        $subTmp['file'] = URL_ROOT . 'update/analysis_new/' . $versionDir . '/' . $file . '/' . $subFile;
                ...
                $tmp['file'] = URL_ROOT . 'update/analysis_new/' . $versionDir . '/' . $file;
