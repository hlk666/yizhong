...
<label>开始时间</label><input type="text" name="start_time" value="$startTime" onclick="SelectDate(this,'yyyy-MM-dd')" />
<label>结束时间</label><input type="text" name="end_time" value="$endTime" onclick="SelectDate(this,'yyyy-MM-dd')" />
